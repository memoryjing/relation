...
def write_set_file(fileName, data_set):
    list = [elem for elem in data_set]
    writeStrLines(fileName, list)


def writeStrLines(fileName, strlist):
    writeObj = open(fileName, 'w',encoding="utf-8")
...
if __name__ == '__main__':
    ...
    print(len("\t"))
    dir ='C:/Users/Administrator/Desktop/abs.txt'
    for line in open(dir,encoding="utf-8"):
        line = line.encode("utf-8")
        print(line)
        print(line[1342:1354])
